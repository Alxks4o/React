...
export default function Register(){
    ...
    const handleSubmit = (event) => {
        ...
        { 
            ...
            console.log(error)
            setShow(true);
            setMessage("The password you entered did not match")
        }  
    };
                                    ...
                                    <Card.Text>
                                        <Form onSubmit={handleSubmit}>
                                            ...
                                            <Form.Group className="mb-3" controlId="formBasicPasswordRepeat">
                                                ...
                                                <Form.Control name='repeat_password' type="password" placeholder="Password" required onChange={handleChange}></Form.Control>
                                            </Form.Group>    
